...
def studentDetailView(request,pk):
    ...
    #updating the Student and Deleting the Student
...
#             raise Http404 #it is need to import for except in class based operation
...
class EmployeeViewset(viewsets.ModelViewSet):
    ...
    # filterset_fields = ['designation']  # for global filter
    #for local Filter
...
class BlogsView(generics.ListCreateAPIView):
    ...
    # search_fields = ['^blog_title'] # serach Which IS Start With something
